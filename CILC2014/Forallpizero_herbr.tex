...
for $\Lang$ and assignments $A$ in $\inter$. Also, we mention
the\marginpar{Issue 26} \emph{entailment problem}, which is of particular
interest for applications in the field of knowledge representation as we will
see in Section \ref{TODO}. Let $\varphi$ and $\psi$ two formulae of a
first order language $\Lang$. We say that $\varphi$ entail $\psi$, and
